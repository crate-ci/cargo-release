...
| `allow-branch` |                 | list of globs | Which branches are allowed to be released from |
...
| `consolidate-pushes` | \- | bool | When releasing a workspace, do a single push across all crates in a workspace. |
